...
export const getDashboard = async (): Promise<DashboardDto> => {
    ...
    const last14Days = [13, 12, 11, 10, 9, 8, 7, 6, 5, 4, 3, 2, 2, 1, 0].map(
    (day) => {
    ...
    const mostSoldProductsQuery = `
        ...
        LIMIT 5;
    `;
    const mostSoldProductsPromise = db.$queryRawUnsafe<{productId: string; name: string; totalSold: number; stock: number; price: number }[]
